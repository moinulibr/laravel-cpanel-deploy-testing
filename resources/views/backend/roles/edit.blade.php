                    ...
                    <div class="row mt-2">
                        <div class="col-md-12 mt-2">
                            ...
                            @foreach($permissions as $permission)
                                <h6><label class="mb-1 mt-2"><input type="checkbox" class="permission-item" name="permissions[]" value="{{$permission->id}}" @if($permission->id == $permission->hasRole($role)) checked @endif> {{$permission->name}}</label></h6>
                            @endforeach
                        </div>
                    </div>
                    <hr>
